---
layout: page
permalink: /aulas/graduacao/2026-2/arquitetura-computadores-sistemas-operacionais/
title: Arquitetura de Computadores e Sistemas Operacionais — 2026/2
...
_styles: >-
  ...
  .lesson-item { display: grid; grid-template-columns: 56px minmax(0, 1fr) minmax(220px, 330px); gap: 1rem; align-items: start; padding: 1.3rem 0; border-top: 1px solid var(--global-divider-color); }
  ...
  .lesson-action { display: flex; flex-direction: column; align-items: flex-start; justify-self: start; width: 100%; min-width: 0; max-width: 330px; gap: .45rem; white-space: normal; overflow-wrap: anywhere; font-size: .9rem; padding-top: .15rem; text-align: left; }
  ...
  @media (max-width: 860px) { .lesson-item { grid-template-columns: 48px 1fr; } .lesson-action { grid-column: 2; width: auto; min-width: 0; max-width: none; padding-top: 0; white-space: normal; } }
---

{% assign course = site.data.courses['arquitetura-computadores-so'] %}

<div class="course-breadcrumb">
  <a href="{{ '/aulas/' | relative_url }}">Aulas</a> / <a href="{{ '/aulas/graduacao/' | relative_url }}">Graduação</a> / <a href="{{ '/aulas/graduacao/2026-2/' | relative_url }}">2026/2</a> / Arquitetura de Computadores e Sistemas Operacionais
</div>
